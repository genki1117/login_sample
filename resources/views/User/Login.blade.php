					...
					<div class="card-body p-5 text-center">
						...
						<form action="{{ route('login.post') }}" method="post" class="form">
							...
							<div class="form-outline mb-4">
								<input name="email" type="email" placeholder="Email Address" class="form-control form-control-lg"> </div>
							<div class="form-outline mb-4">
								<input name="password" type="password" placeholder="Password" class="form-control form-control-lg"> </div>
							<div class="form-outline mb-4 d-grid gap-2">
								<button type="submit" class="btn btn-info">Login </button>
							</div>
							<div>
								<p class="mb-2"> Don't have an account? <a class="text-white-50 fw-bold" href="#!">Sign up</a></p>
							</div>
							<hr class="my-4"> </form>
					</div>
				</div>
